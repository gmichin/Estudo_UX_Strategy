...
- Estratégia de Negócios: Ao falarmos em estratégia de negócios, estamos nos referindo à análise ampla da empresa, que inclui o público-alvo, objetivos, missão, visão e valores. É importante ter uma visão geral da empresa para definir as melhores ações a serem tomadas para alcançar as metas estabelecidas.
- Inovação de Valor: Nesse momento, é realizada a análise do cenário do negócio, onde serão abordados temas como macro e microambiente, além da análise SWOT, como parte da estratégia de negócios. Após diagnosticar a visão estratégica do negócio, podemos planejar o tipo de inovação a ser desenvolvida, sendo a inovação de valor aquela que visa romper com o status quo de um produto ou serviço, tirando o comportamento de consumo da zona de conforto e evoluindo a forma como oferecemos produtos e serviços. Isso significa que vamos promover inovação. Ao adquirirmos um conhecimento mais sólido sobre o negócio e o mercado em que ele está inserido, podemos ter uma noção da inovação a ser desenvolvida.
...
Segundo a Dora Steimer, arquiteta de informação e UX Researcher, ou seja, pesquisadora de UX, existem três perfis de quem trabalha com UX:

- Pesquisadores: Conseguem identificar dores, necessidades, comportamentos e tendências de usuários, além de transformar essas descobertas em informações úteis, que servem de alimento para quem é estrategista ou criador. Estes profissionais transitam bastante entre a área de dados e etnografia. Em geral, são analíticos. As empresas têm contratado pessoas da área da sociologia e ciências humanas para compor equipes dos times de UX, especialmente UX Strategy, porque elas têm as habilidades necessárias para desenvolver esse processo de pesquisa com eficiência.
...
![SWOT](https://github.com/user-attachments/assets/a3601a96-00cd-4eb1-98a3-225d6c391eac)
...
4. A aprendizagem ativa se refere ao aprendizado ao longo da vida. Vamos supor que resolvemos desenvolver uma plataforma de educação na área da moda - uma fashion tech relacionada com educação na moda. A partir deste contexto, o ideal é estudar educação digital para o resto da vida. Acompanhar e incorporar ao seu negócio cada nova tecnologia que surgir. O Lifelong learning, conceito bastante atual, realmente merece nossa atenção. A aprendizagem ativa não se trata de uma busca insana por conteúdo, mas, sim, se dedicar de forma organizada e coerente ao que se propõe como profissional ou empresa.
5. Inovação: A palavra "inovação" permeia o mundo dos negócios digitais. Como empreendedores, não podemos deixar de pensar sobre como inovar. A inovação é uma habilidade que podemos desenvolver. Ela está relacionada com a criatividade e, principalmente, com a capacidade de buscar referências, além de utilizá-las nos projetos, produtos e serviços. A inovação está mais ligada à curiosidade, ao conhecimento, que a um dom. Pode ser que algumas pessoas tenham mais habilidades criativas, mas, elas são desenvolvidas a partir de técnicas que aperfeiçoamos ao longo da vida. Conversamos sobre as habilidades importantes para os profissionais do futuro e agora podemos utilizá-las e desenvolvê-las no trabalho ou negócio.
